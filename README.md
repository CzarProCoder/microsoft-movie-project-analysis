...
The presentation describes the project **_goals, data, methods, and results_**. It must include at least **_three visualizations_** which correspond to **_three business recommendations_**.
